      ...
      <>
        <div className="w-full flex flex-col gap-5 mt-10 mb-5">
          ...
          <div
            ...
            bg-cover sm:bg-cover px-6 sm:px-12"
          >
            ...
            <button className="hidden sm:block px-3 py-2 bg-white hover:bg-[#DFE0E1] font-semibold rounded-[2px] cursor-pointer">
              SHOP NOW
            </button>
          </div>
        </div>
  
        <div className="sm:hidden w-full flex flex-col items-center justify-center my-5 gap-5 py-5">
          ...
          <button className="block sm:hidden px-3 py-2 bg-white hover:bg-[#DFE0E1] font-semibold rounded-[2px] cursor-pointer">
            SHOP NOW
          </button>
        </div>
      </>
